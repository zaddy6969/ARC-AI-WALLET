...
export const ARC_CIRBTC_ERC20_ADDRESS =
  process.env.NEXT_PUBLIC_ARC_TESTNET_CIRBTC_ADDRESS || "";

export const ARC_PORTFOLIO_TOKENS = [
  {
    symbol: "USDC",
    name: "USD Coin",
  ...
  },
  {
    symbol: "EURC",
    name: "Euro Coin",
    address: ARC_EURC_ERC20_ADDRESS,
    decimals: 6,
    priceUsd: 1.08,
    accent: "E",
  ...
  },
  {
    symbol: "cirBTC",
    name: "Circle Bitcoin",
    address: ARC_CIRBTC_ERC20_ADDRESS,
    decimals: 8,
    priceUsd: 0,
    accent: "B",
    description: "Arc Testnet swap/faucet asset"
  }
];
