...
export const EXTRA_WALLET_CHAINS = [
  mainnet,
  base,
  polygon,
  arbitrum,
...
export const SUPPORTED_WALLET_NETWORKS = [
  {
    name: arcTestnet.name,
    helper: "Primary network for Arc AI Wallet actions.",
    status: "Primary"
  },
  {
    name: "Ethereum Sepolia",
    helper: "Bridge source for testnet USDC into Arc.",
    status: "Bridge"
  },
  {
    name: "Base Sepolia",
  ...
  ...EXTRA_WALLET_CHAINS.map((chain) => ({
    name: chain.name,
    helper: "Wallet connection and future USDC expansion.",
    status: "Wallet"
  }))
];
