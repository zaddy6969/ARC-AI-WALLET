...
export const ARC_AI_WALLET_ASSISTANT_CONTRACT_ADDRESS = ARC_MAINNET_REQUESTED
  ? process.env.NEXT_PUBLIC_ARC_MAINNET_ASSISTANT_CONTRACT_ADDRESS || ""
  : process.env.NEXT_PUBLIC_ARC_ASSISTANT_CONTRACT_ADDRESS || deployment.address || "";
